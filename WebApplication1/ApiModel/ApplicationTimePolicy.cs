...
namespace WebApplication1.ApiModel
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationTimePolicy :  IEquatable<ApplicationTimePolicy>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationTimePolicy" /> class.
        /// </summary>
        ...
        public ApplicationTimePolicy(TypeEnum type = default(TypeEnum), string from = default(string), string to = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ApplicationTimePolicy and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as ApplicationTimePolicy);
        }

        /// <summary>
        /// Returns true if ApplicationTimePolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationTimePolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationTimePolicy input)
        {
            if (input == null)
                return false;
