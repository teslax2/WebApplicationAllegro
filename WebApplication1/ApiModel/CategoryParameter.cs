...
namespace WebApplication1.ApiModel
{
    ...
    /// </summary>
    [DataContract]
        public partial class CategoryParameter :  IEquatable<CategoryParameter>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoryParameter" /> class.
        /// </summary>
        /// <param name="id">The ID of the parameter..</param>
        /// <param name="name">The name of the parameter in Polish..</param>
        /// <param name="type">The type of the parameter. Other fields in this structure may appear based on the type of the parameter. (required).</param>
        /// <param name="required">Indicates whether the value of this parameter must be set in an offer. Offers without required parameters set cannot be published..</param>
        /// <param name="unit">The unit in which values of the parameter are used. May be &#x60;null&#x60;..</param>
        /// <param name="options">options.</param>
        public CategoryParameter(string id = default(string), string name = default(string), TypeEnum type = default(TypeEnum), bool? required = default(bool?), string unit = default(string), CategoryParameterOptions options = default(CategoryParameterOptions))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for CategoryParameter and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as CategoryParameter);
        }

        /// <summary>
        /// Returns true if CategoryParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of CategoryParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CategoryParameter input)
        {
            if (input == null)
                return false;
