...
namespace WebApplication1.ApiModel
{
    ...
    /// </summary>
    [DataContract]
        public partial class CheckoutFormAddWaybillRequest :  IEquatable<CheckoutFormAddWaybillRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutFormAddWaybillRequest" /> class.
        /// </summary>
        /// <param name="carrierId">Carrier identifier taken from the dictionary below. It’s highly recommended to use an identifier different from OTHER, because its parcel status may be updated automatically. Carrier identifier OTHER is reserved for cases when seller uses a custom carrier or not yet integrated with Allegro. (required).</param>
        /// <param name="waybill">Waybill number (parcel tracking number). Cannot be empty and must be no longer than 64 characters. It can contain any word character (equal to [a-zA-Z0-9_]) and special characters: parentheses and hyphen-minus. (required).</param>
        ...
        /// <param name="lineItems">List of order line items. They must be from the order specified in the path parameter. List cannot be empty. (required).</param>
        ...
        {
            return this.Equals(input as CheckoutFormAddWaybillRequest);
        }

        /// <summary>
        /// Returns true if CheckoutFormAddWaybillRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckoutFormAddWaybillRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckoutFormAddWaybillRequest input)
        {
            if (input == null)
                return false;
